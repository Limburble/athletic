/* Tonight — the invitation. The front door. */

const SaTonight = ({ state, set }) => {
  ...
  return (
    <div className="sa-app" data-sa-mode={mode}
      ...
      <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '32px 20px 0' }}>
          <div className="sa-panel sa-enter" style={{ animationDelay: '0.1s', padding: '28px 24px 24px' }}>
            ...
            <button className="sa-cta" onClick={() => set({ tab: 'path' })}>
              Begin
        ...
        <div className="sa-enter" style={{ padding: '24px 28px 0', animationDelay: '0.2s' }}>
          ...
          {[
            ...
            <div key={i} className="sa-tap"
              onClick={() => set({ tab: 'path' })}
              style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{
                  ...
                  fontSize: 17, color: 'var(--sa-ink-1)',
                  marginBottom: 2,
                }}>{opt.t}</div>
      ...
      <SaDock tab="tonight" onTab={(t) => set({ tab: t })} />
    </div>
  );
};

Object.assign(window, { SaTonight });
